...
class komonoViewController: UIViewController,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout {
    ...
    func read(){
        ...
        query.predicate = NSPredicate(format:"category = %@","その他小物")
